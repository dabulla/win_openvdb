...
set /p MY_DEVENV=Specify full path of devenv.exe (with quotation marks). E.g. "C:\Program Files (x86)\Microsoft Visual Studio 12.0\Common7\IDE\devenv.exe"
...
echo Compiling zlib
"%MY_DEVENV%" zlib.sln /build "Debug" /project ALL_BUILD
...
"%MY_DEVENV%" /build "Debug" IlmBase.sln /project ALL_BUILD
"%MY_DEVENV%" /build "Release" IlmBase.sln /project ALL_BUILD
...
"%MY_DEVENV%" /build "Debug" OpenEXR.sln /project ALL_BUILD
"%MY_DEVENV%" /build "Release" OpenEXR.sln /project ALL_BUILD
...
"%MY_DEVENV%" /build "Debug" OpenVDB.sln /project ALL_BUILD
"%MY_DEVENV%" /build "Release" OpenVDB.sln /project ALL_BUILD
echo Done!
cd ..\..\..\..